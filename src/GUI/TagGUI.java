...
public class TagGUI extends javax.swing.JFrame {
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(!lsm.isSelectionEmpty()){
                    ...
                    FormTagGUI t = new FormTagGUI(tagSelected);
                    setVisible(false);
                }               
            }
        });
    ...
    public void addTag() {
        jButton4.setText("+");
        jButton4.setMnemonic(KeyEvent.VK_V);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TagGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
