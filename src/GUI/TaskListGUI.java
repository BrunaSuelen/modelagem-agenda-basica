...
public class TaskListGUI extends javax.swing.JFrame {
    ...
    static String[] array = { "Data Final", "Titulo", "Descrição","Etiqueta" };
    ...
    private void initTableSelectionListener() {                
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(!lsm.isSelectionEmpty() && isVisible()){
    ...
    public void getTaskList() {
        ...
        for (int i = 0; i < taskList.size(); i++) {
            ...
            tableList[i][0] = final_date;
            tableList[i][1] = task.getTitle();
            tableList[i][2] = task.getDescription();
